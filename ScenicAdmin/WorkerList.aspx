        ...
        <asp:Repeater ID="rptScenicAdmin" runat="server" OnItemDataBound="rptScenicAdmin_ItemDataBound">
            ...
            <ItemTemplate>
                <tr style="background-color: #F9F9F9">
                    ...
                    <td style="background-color: #F9F9F9">
                        <asp:LinkButton ID="LinkButton1" CssClass="lkbtnxg" runat="server" PostBackUrl='<%# Eval("Membership.Id","/WorkerAssign.aspx?userid={0}") %>'></asp:LinkButton><a
                            class="axg" href="/WorkerAssign.aspx?userid=<%#Eval("Membership.Id") %>">修改</a>
                    </td>
