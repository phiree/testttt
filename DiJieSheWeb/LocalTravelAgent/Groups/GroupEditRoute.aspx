...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" runat="Server">
    <div class="navlist">
        <a runat="server" id="a_link_1" href="/LocalTravelAgent/Groups/GroupEditBasicInfo.aspx">
            团队基本信息</a> <a runat="server" id="a_link_2" href="/LocalTravelAgent/Groups/GroupEditMember.aspx">
                游客信息</a> <a runat="server" id="a_link_3" href="/LocalTravelAgent/Groups/GroupEditRoute.aspx"
                    class="selectstate">行程信息</a> <span id="groupname">团队名称:<%=CurrentGroup.Name %></span>
    </div>
    <div id="tabs">
        <!--  <ul>
        ...
        <div id="tabs-1" style="margin-top: 4px">
            ...
            <asp:Button runat="server" ID="btnAddRoute" OnClick="btnAddRoute_Click" Visible="false"
                Text="增加行程" CssClass="btn2" Style="margin-top: 10px" />
        ...
        <div id="tabs-2" style="display: none">
            ...
            <asp:TextBox TextMode="MultiLine" runat="server" ID="tbxSimple" CssClass="tbMemberSingleText"
