<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DptLogin.aspx.cs" Inherits="Login2" %>
...
<head runat="server">
    ...
    <link href="/theme/default/css/Login2.css" rel="stylesheet" type="text/css" />
</head>
<body>
    ...
    <table border="0" cellpadding="0" cellspacing="0">
        <tr>
            <td>
                <img src="theme/default/image/login2_01.gif" />
            </td>
            <td>
                <img src="theme/default/image/login2_02.gif" />
            </td>
            <td>
                <img src="theme/default/image/login2_03.gif" />
            </td>
        </tr>
        <tr>
            <td>
                <img src="theme/default/image/login2_04.gif" />
            </td>
            <td>
                <div id="login">
            ...
            <td>
                <img src="theme/default/image/login2_06.gif" />
            </td>
        </tr>
        <tr>
            <td>
                <img src="theme/default/image/login2_15.gif" />
            </td>
            <td>
                <img src="theme/default/image/login2_16.gif" />
            </td>
            <td>
                <img src="theme/default/image/login2_17.gif" />
            </td>
        </tr>
        <tr>
            <td colspan="3">
