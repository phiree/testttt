        ...
        <asp:Repeater ID="rptVisited" runat="server" 
            ...
            <HeaderTemplate>
                <div class="vtitlename">
                    <span class="vtfirst">时间</span><span class="vtsecond">景区名称</span><span class="vtthird">购票方式</span><span class="vtfour">价格</span><span class="vtfifth">数量</span><span class="vtsix">游客名称</span>
                </div>
            </HeaderTemplate>
            <ItemTemplate>
                <div class="vinfo">
