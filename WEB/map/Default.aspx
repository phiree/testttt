<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Default.aspx.cs" Inherits="map_DefaultMap" %>
...
<body>
    <form id="form1" runat="server">
        <div id="top">
            ...
            <a href="Default.aspx" style="cursor:pointer;"><span class="topleft"></span></a>
            <div class="topmid">
                ...
                <div class="areaname" id="areaid">
                    <asp:Repeater ID="rptarea" runat="server" 
                        ...
                        <ItemTemplate>
                            <a runat="server" id="areaname" onclick="qdpostion();" href='<%# Eval("Id","Default.aspx?areaid={0}") %>'><%# Eval("Name")  %></a>
                        </ItemTemplate>
                    </asp:Repeater>
                </div>
                <div class="level">
