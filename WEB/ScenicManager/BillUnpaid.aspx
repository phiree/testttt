...
<asp:Content ID="Content2" ContentPlaceHolderID="cphmain" runat="Server">
    ...
    <div class="searchtime">
        查询日期&nbsp;<asp:TextBox ID="txtbegin" Text="201201" runat="server" CssClass="txtdate" onchange="showdate()" />&nbsp;至&nbsp;<asp:TextBox ID="txtend" Text="201212" runat="server" CssClass="txtdate" onchange="showdate()" />
    </div>
    <div id="spmain">
        <div class="odstate">订单状态&nbsp;
            <asp:DropDownList ID="ddlCondition" runat="server" CssClass="ddlstate" 
                AutoPostBack="True" onselectedindexchanged="ddlCondition_SelectedIndexChanged">
            ...
            <HeaderTemplate>
                <table cellpadding="0" cellspacing="0" class="sptable">
                    <tr style=" height:30px; background-color:#CBDFF2; display:block; padding:0px; margin:0px;text-align:left;">
                        <td colspan="8" style="  display:inline-block; padding:0px; margin:0px; text-align:left; border:0px none;" >
