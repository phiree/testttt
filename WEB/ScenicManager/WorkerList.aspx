<%@ Page Title="" Language="C#" MasterPageFile="~/ScenicManager/sm.master" AutoEventWireup="true" CodeFile="WorkerList.aspx.cs" Inherits="ScenicManager_WorkerList" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphmain" Runat="Server">
    ...
    <div class="btndelete">
        <asp:Button ID="btnDelete" runat="server" CssClass="deletebtn" 
